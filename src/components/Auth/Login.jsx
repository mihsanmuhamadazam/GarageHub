      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#0f1419] to-[#0c0f14] items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
            Manage your fleet with precision and control.
          </h2>
          ...
          <div className="space-y-4">
            {[
              'Real-time vehicle tracking & availability',
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-600 bg-transparent text-blue-500 focus:ring-blue-500/20" />
